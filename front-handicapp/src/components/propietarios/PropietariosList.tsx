...
import { propietarioService, type Propietario } from '@/lib/services/propietarioService';
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex justify-between items-center">
          <h3 className="text-xl font-bold text-gray-900 flex items-center gap-3">
            <div className="p-2 bg-gradient-to-br from-[#0f172a]/10 to-[#af936f]/10 rounded-lg">
      ...
      {propietarios.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12">
          <div className="text-center max-w-md mx-auto">
            <div className="relative inline-block mb-6">
              ...
              <div className="relative w-20 h-20 bg-gray-50 rounded-full flex items-center justify-center mx-auto ring-4 ring-gray-100">
        ...
        <div className="grid gap-6">
          {propietarios.map((prop) => (
            <div
              key={prop.id}
              className={`bg-white rounded-xl shadow-lg p-6 transition-all duration-200 border ${
                prop.actual
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <div className="flex-shrink-0">
                      <div className="relative">
                        <div className="absolute -inset-0.5 bg-gradient-to-r from-[#0f172a] to-[#af936f] rounded-full blur opacity-30"></div>
                        <div className="relative h-14 w-14 rounded-full bg-gradient-to-br from-[#0f172a]/10 to-[#af936f]/10 flex items-center justify-center ring-2 ring-white">
                          <UserIcon className="h-7 w-7 text-[#0f172a]" />
                        </div>
                      </div>
                    </div>
                    <div className="flex-1">
                    ...
                    {prop.actual && (
                      <span className="inline-flex items-center px-3 py-1.5 text-xs font-semibold text-emerald-700 bg-emerald-50 rounded-lg ring-2 ring-emerald-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full pl-3 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brown-500 focus:border-transparent"
                          />
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full pl-3 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brown-500 focus:border-transparent"
                          />
                        </div>
                      </div>
                      <div className="md:col-span-2 flex gap-2">
                        <button
                          ...
                          className="px-6 py-2.5 bg-[#0f172a] text-white rounded-xl hover:bg-[#0f172a]/90 transition-all duration-200 shadow-lg hover:shadow-xl text-sm font-medium"
                        >
                          Guardar
                        </button>
                        <button
                          onClick={() => setEditingId(null)}
                          className="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-all duration-200 text-sm font-medium"
                        >
                          Cancelar
                        </button>
                      </div>
                ...
                {prop.actual && editingId !== prop.propietario_usuario_id && (
                  <div className="flex gap-2 ml-4">
                    <button
                      ...
                      className="p-2.5 text-[#0f172a] hover:bg-[#0f172a]/10 rounded-xl transition-all duration-200 hover:shadow"
                      title="Editar"
                    >
                    ...
                    <button
                      ...
                      className="p-2.5 text-red-600 hover:bg-red-50 rounded-xl transition-all duration-200 hover:shadow"

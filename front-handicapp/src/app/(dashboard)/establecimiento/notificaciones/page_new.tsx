      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-400 text-sm font-medium">No Leídas</p>
                <p className="text-3xl font-bold text-white mt-1">{stats.noLeidas}</p>
              </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-400 text-sm font-medium">Leídas</p>
                <p className="text-3xl font-bold text-white mt-1">{stats.leidas}</p>
              </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-white mt-1">{stats.hoy}</p>
              </div>
          ...
          <CardContent>
            <div className="space-y-3">
              {filteredNotificaciones.map((notif) => (
                <div
                  key={notif.id}
                  className={`p-4 rounded-lg border ${notif.leido ? 'bg-gray-50 border-gray-200' : 'bg-emerald-50 border-emerald-200'}`}
                >

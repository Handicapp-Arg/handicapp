  ...
  return (
    <SimpleRoleGuard roles={['establecimiento']} fallback={
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Caballos del Establecimiento</h1>
          <p className="text-gray-600">Gestiona los caballos en tu establecimiento</p>
        </div>

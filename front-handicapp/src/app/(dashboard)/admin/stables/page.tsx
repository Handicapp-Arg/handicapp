...
import { type Establecimiento, establecimientoService } from '@/lib/services/stableService';
          ...
          <div className="bg-white rounded-md border border-gray-200 overflow-hidden">
            ...
            <div className="bg-gray-900 px-6 sm:px-8 py-6">
              <button
                ...
                className="mb-4 flex items-center gap-2 text-white/80 hover:text-white text-sm"
              >
              ...
              <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                <div className="flex-1 min-w-0">
                  <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">{est.nombre}</h1>
                ...
                <div className="flex gap-2 flex-shrink-0">
                  <button
                    ...
                    className={`px-4 py-2 rounded-md font-medium text-sm flex items-center gap-2 ${
                      est.estado === 'activo'
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-white text-gray-900 rounded-md hover:bg-gray-50 font-medium text-sm"
                  >
                    Editar
                  </button>
                </div>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {est.telefono && (
                      <div className="flex items-center gap-2 text-gray-700">
                        ...
                        <a href={`tel:${est.telefono}`} className="hover:underline">
                          {est.telefono}
                        </a>
                      </div>
                    )}
                    {est.email && (
                      <div className="flex items-center gap-2 text-gray-700">
                        ...
                        <a href={`mailto:${est.email}`} className="hover:underline truncate">
                          {est.email}
                        </a>
                      </div>
                    )}
              ...
              {est.usuarios && est.usuarios.length > 0 && (() => {
                ...
                return adminUser ? (
                  <Card className="border border-gray-200 bg-gray-50">
                    ...
                    <CardContent>
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 bg-white rounded-md border border-gray-200">
  ...
  return (
    <SimpleAdminOnly>
      <PageShell
        ...
        description="Administra establecimientos ecuestres y sus configuraciones"
        action={
          <button
            onClick={handleCreateNew}
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-gray-900 text-white rounded-md font-medium hover:bg-gray-700"
          >

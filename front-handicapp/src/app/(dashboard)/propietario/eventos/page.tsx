              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mt-0.5">
                      Historial completo de actividades de tus caballos
                    </p>
                  </div>
                </div>
                ...
                {eventosStats.autoGenerados > 0 && (
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-purple-50 border border-purple-200 rounded-lg text-xs sm:text-sm text-purple-700 mt-2">
                    ...
                    <span>
                      <span className="font-semibold">{eventosStats.autoGenerados}</span> actividades completadas automáticamente por el equipo
                    </span>
                  </div>
                )}
              </div>

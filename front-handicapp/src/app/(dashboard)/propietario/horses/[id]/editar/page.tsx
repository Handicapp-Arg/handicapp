...
import { useCaballo, useActualizarCaballo } from '@/lib/hooks/useHorsesQuery';
...
export default function EditarCaballoPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/propietario/horses/${idNum}?updated=${Date.now()}`);
    } catch (e) {
    ...
    <SimpleRoleGuard roles={['propietario']} fallback={<div className="p-6">Sin permisos</div>}>
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <div className="mb-6">
            <button 
              onClick={() => router.push(`/propietario/horses/${idNum}`)} 
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex flex-col items-center">
                    <div className="w-48 h-48 bg-gray-100 rounded-md overflow-hidden flex items-center justify-center mb-4">
                      {previewUrl ? (
                        <Image 
                          src={previewUrl} 
                          alt="Caballo" 
                    ...
                    <div className="w-full">
                      <input 
                        ...
                        disabled={uploading}
                        className="w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200"
                      />
                      {uploading && (
                        <div className="flex items-center gap-2 mt-2">
                          <div className="w-4 h-4 border-2 border-gray-200 border-t-gray-700 rounded-full animate-spin"></div>

  ...
  return (
    <SimpleRoleGuard roles={['propietario']} fallback={<div className="p-6">Sin permisos</div>}>
      <div className="max-w-3xl mx-auto px-4 py-6">
          <button onClick={() => router.push('/propietario/horses')} className="text-sm text-gray-600 mb-4">← Volver</button>
          <div className="bg-white rounded-md border border-gray-200 p-6">
            <h1 className="text-2xl font-semibold text-gray-900 mb-6">Nuevo Caballo</h1>
            ...
            <form onSubmit={onSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input 
                      ...
                      value={form.nombre} 
                      onChange={onChange} 
                      className="w-full border border-gray-300 rounded-md p-2.5 focus:ring-2 focus:ring-gray-300 focus:border-gray-400" 
                      required 
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      onChange={onChange} 
                      className="w-full border border-gray-300 rounded-md p-2.5 focus:ring-2 focus:ring-gray-300 focus:border-gray-400 font-mono" 
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
                <button 
                  type="button" 
                  onClick={() => router.back()} 
                  className="px-6 py-2.5 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium"
                >
                  Cancelar
                </button>
                <button 
                  type="submit" 
                  disabled={saving} 
                  className="px-6 py-2.5 rounded-md bg-gray-900 text-white hover:bg-gray-700 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >

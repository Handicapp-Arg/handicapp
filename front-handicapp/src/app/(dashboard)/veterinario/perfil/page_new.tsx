        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-400 text-sm font-medium">Nombre</p>
                <p className="text-2xl font-bold text-white mt-1">{stats.nombre}</p>
              </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-white mt-1 truncate">{stats.email}</p>
              </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-white mt-1">{stats.rol}</p>
              </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-400 text-sm font-medium">Estado</p>
                <p className="text-xl font-bold text-white mt-1">{stats.activo ? 'Activo' : 'Inactivo'}</p>
              </div>
              <div className={`w-12 h-12 rounded-xl ${stats.activo ? 'bg-green-500/20' : 'bg-gray-500/20'} flex items-center justify-center`}>
                <User className={`w-6 h-6 ${stats.activo ? 'text-green-400' : 'text-gray-400'}`} />
              </div>
            </div>
            <div className="mt-4">
              <Badge variant={stats.activo ? 'default' : 'secondary'} className={stats.activo ? 'bg-green-500/10 text-green-300 border-green-500/20' : 'bg-gray-500/10 text-gray-300 border-gray-500/20'}>

...
import { SimpleRoleGuard roles={["veterinario"]} } from '@/components/common/SimplePermissionGuard';
  ...
  if (loading || loadingTareas) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <LoadingSpinnerFullPage label="Cargando..." variant="info" />
      </div>
    );
  }
    ...
    <SimpleRoleGuard roles={["veterinario"]}>
      <div className="mx-auto">
        <div className="relative overflow-hidden mb-8 rounded-2xl">
          ...
          <div className="absolute bottom-0 left-1/3 w-48 h-48 bg-violet-500/20 rounded-full blur-3xl"></div>

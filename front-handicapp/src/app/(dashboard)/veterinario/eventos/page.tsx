    ...
    <SimpleRoleGuard roles={['veterinario']}>
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <PageHeader
          ...
          subtitle="Gestiona consultas, tratamientos y procedimientos médicos"
        />
        ...
        {autoGenerados > 0 && (
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#af936f]/10 border border-[#af936f]/20 rounded-xl text-sm text-[#af936f]">
            ...
            <span>
              <span className="font-semibold">{autoGenerados}</span> consultas completadas automáticamente
            </span>
          </div>
        )}
